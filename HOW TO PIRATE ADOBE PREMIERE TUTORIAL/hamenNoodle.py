...
def flipBug(startTime, endTime):
    """Makes notes only up and down. Similar to 1.12.1 rotation bug
    ...
    for index in range(len(exData['colorNotes'])):
        if (exData['colorNotes'][index]['b'] >= startTime) and (exData['colorNotes'][index]['b'] <= endTime):
            rotation = exData['colorNotes'][index]['d']
            ...
            exData['colorNotes'][index]['customData'] = nData
